...
- [x] 구역/적 데이터 정의 (`src/data/zones.ts` — 구역 4개, 적 17종)
- [x] 이벤트 데이터 정의 (`src/data/events.ts` — 13종: 공통 4 + 구역 1 전용 3 + 구역 2 전용 3 + 구역 3 전용 3)
...
- [x] 구역 1 적 데이터 (일반 3종, 엘리트 1종, 보스 1종) 확정
- [x] 구역 1 이벤트 세트 완성 (공통 4종 + 구역 1 전용 3종, 구역별 필터링)

### 구역 2/3 데이터 확장

- [x] 구역 2 적 데이터 (일반 3종, 엘리트 1종, 보스 1종) 확정
- [x] 구역 2 이벤트 세트 완성 (구역 2 전용 3종)
- [x] 구역 3 적 데이터 (일반 3종, 엘리트 1종, 보스 1종) 확정
- [x] 구역 3 이벤트 세트 완성 (구역 3 전용 3종)
...
- [x] 구역 2 (성운 지대) 적/이벤트 완성
- [x] 구역 3 (적 본거지) 적/이벤트 완성
- [x] 최종 보스 (보이드 리바이어던) 구현
- [ ] 전체 장비 목록 밸런스 완료
- [ ] 전체 카드 밸런스 완료
