...
| 2 | 기계 드론 (25HP), 기계 요격기 (30HP), 기계 수호자 (40HP) | 기계 사령관 (65HP) | 기계 요새 (150HP) |
| 3 | 함대 초계함 (35HP), 함대 구축함 (50HP), 함대 순양함 (55HP) | 정예 함장선 (80HP) | 제독 기함 (200HP) |
| 4 | — | — | 보이드 리바이어던 (300HP) |
...
| `nebula_interference` | 성운 간섭 지대 | 2 | 50% 데이터코어+2 / 50% HP-10 | 우회 |
| `derelict_factory` | 버려진 기계 공장 | 2 | 40% 희귀장비 / 30% 스크랩+35 / 30% HP-8+적강화 | 무시 |
| `rogue_ai_signal` | 이탈 AI 신호 | 2 | 70% 최대HP+5+스크랩+20 / 30% 저주 장비 | 무시 |
| `fleet_deserter` | 탈영 함선 | 3 | 60% 스크랩+45+HP+10 / 40% HP-12 | 거부 |
| `enemy_supply_depot` | 적 보급 기지 | 3 | 50% 장비+스크랩+30 / 50% HP-15+적강화 | 우회 |
| `encrypted_transmission` | 암호화된 통신 | 3 | 50% 데이터코어+2+스크랩+25 / 30% 스크랩+15 / 20% HP-10+적강화 | 무시 |
